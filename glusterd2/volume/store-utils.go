...
// and checks if all replicate, Disperse volumes are stopped except input volume ID
//before stopping the self heal daemon.
//skipVolID will be skipped, as this volume info is not yet updated in store
